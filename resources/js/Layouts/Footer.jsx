      ...
      <Container>
        <Row>
          <Col lg="6" className="h-100 text-center text-lg-start my-auto">
            ...
            <p className="text-muted small mb-4 mb-lg-0">© Platita 2023. Todos los derechos reservados a X.</p>
          </Col>
          <Col lg="6" className="h-100 text-center text-lg-end my-auto">
            <ul className="list-inline mb-0">
              <li className="list-inline-item me-4">
                <a href="#!"><i className="bi-facebook fs-3 footer_a" /></a>
              </li>
              <li className="list-inline-item me-4">
                <a href="#!"><i className="bi-twitter fs-3 footer_a" /></a>
              </li>
              <li className="list-inline-item">
                <a href="#!"><i className="bi-instagram fs-3 footer_a" /></a>
              </li>
            </ul>
          </Col>
        </Row>
