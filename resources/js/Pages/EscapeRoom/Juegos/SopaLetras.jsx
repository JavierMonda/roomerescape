...
export default function Guest() {
    ...
    function ChequearSL(){
        ...
        const pepe = contenedor.querySelectorAll("div");
        const cheqeo = pepe[0].lastChild.className;
        if(cheqeo == 'letra solved found complete'){
            ...
            console.log('cagaste');
            const flash = document.body.getElementsByClassName("flash");
            const p = document.createElement("p");
            const content = document.createTextNode("No ha finalizado correctamente el juego");
