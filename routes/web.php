...
Route::get('/blog/show/1', [PostController::class, 'show']);

// Rutas de Escape-rooms visibles
Route::get('/escape-rooms', [ScapeRoomController::class, 'index']);
Route::get('/escape-room/show/1', [ScapeRoomController::class, 'show']);
Route::get('/escape-room/1/play', [ScapeRoomController::class, 'play']);
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/escape-room/play/{sr}', [ScapeRoomController::class, 'play']);
});
